...
QUERY_URL_NORMAL = "http://localhost:8983/solr/books/select?defType=edismax&fq=description%3A%20friends&fq=genres%3A%20romance&indent=true&q.op=OR&q=christmas%20gift&qf=reviews"
